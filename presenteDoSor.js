...
let fruta3 = "abacaxi"
fruta3 = fruta.replaceAll('a','o')
console.log(fruta3)

// 6. Crie uma constante chamada `animal3` que contenha a string "cachorro", e verifique se a palavra "carro" esta incluida nela.
...
const anima14 = "Papagaio"
console.log(anima14.toLowerCase())
console.log(anima14.toUpperCase())

// 9. Crie uma variável chamada `fruta5` com a string "melancia" e substitua todas as letras "i" por "a".
let fruta5 = "melancia"
fruta5 = fruta5.replaceAll("i","a")
console.log(fruta5)
...
const anima15 = "tigre siberiano de bengala dentes de sabre bionico decepticom ultrawide ergonomico antiderrapante"
console.log(anima15.includes('sabre'))
...
animais2.splice(0,1) //segundo modo
console.log(animais2)
animais2.shift() //primeiro modo
...
let novaFrase = frutas3.replaceAll("kiwi","ameixa")
