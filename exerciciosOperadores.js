...
console.log("x12 e maior que y12: ", x12 > y12)
console.log("y12 e menor ou igual a x12: ", y12 <= x12)
console.log("x12 e igual a y12: ", x12 === y12)
...
let resultado = (anoAtual - idade).toString()
...
comsole.log(resultado14, typeof resultado14)
...
let HotasTrabalhadas = 90
let valorHora = 40

let totalAreceber = HotasTrabalhadas * valorHora
console.log("este trabalhador recebeu mais de 500 reais:", totalAreceber > 500)
